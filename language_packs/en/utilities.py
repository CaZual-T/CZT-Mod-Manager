...
LOG_HOTKEY_LINK_DONE = "[LINK] {game_name}: Enabled mods have been linked to {path}"
LOG_HOTKEY_UNLINK_DONE = "[UNLINK] {game_name}: Mod links have been removed from {path}"
...
LOG_LAUNCH_REFRESHING_SYMLINKS = "[LINK] Refreshing symlinks..."
...
LOG_FORZATECH_DEPLOYED = "[ForzaTech] Deployed {count} overlay object(s) into the game."
...
LOG_FORZATECH_REMOVED = "[ForzaTech] Removed {count} overlay object(s) from the game."
