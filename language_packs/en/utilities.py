...
DLG_TITLE_LOAD_ORDER_BLOCKED = "Load Order Blocked"
MSG_LOAD_ORDER_BLOCKED_PROFILE = "Load order menu is disabled for this profile: {profile_name}"
LBL_LOAD_ORDER_TITLE = "Select a mod then use the controls below to generate load order file."
LBL_LOAD_ORDER_SUBTITLE = "> Click 'Save Order' to apply changes, then Launch Game! (that's it!)\n> Load order is persistent until changed again."
BTN_LOAD_ORDER_MOVE_UP = "Move Up"
BTN_LOAD_ORDER_MOVE_DOWN = "Move Down"
BTN_LOAD_ORDER_SAVE_ORDER = "Save Order"
LBL_LOAD_ORDER_LEGEND_CONTROLS = "Controls:"
LBL_LOAD_ORDER_LEGEND_MOVE_UP = "Move Up"
LBL_LOAD_ORDER_LEGEND_MOVE_DOWN = "Move Down"
LBL_LOAD_ORDER_LEGEND_DRAG = "Drag: Move Up or Down"
LBL_LOAD_ORDER_LEGEND_SAVE = "Save: Set Load Order"
DLG_TITLE_SAVE = "Save"
...
# ===== plugins/F3_Menu.py =====
DLG_TITLE_PLUGIN_MANAGER = "Plugin Manager"
BTN_PLUGIN_MENU = "Plugins Menu"
LBL_PLUGIN_MANAGER_INSTALLED = "Installed plugins"
BTN_PLUGIN_MANAGER_RESCAN = "Rescan"
MSG_PLUGIN_MANAGER_NOT_INITIALISED = "Plugin manager is not initialised."
MSG_PLUGIN_MANAGER_EMPTY = (
    "No plugins found.\n\n"
    "Drop plugin folders into:\n  {plugins_root}\n\n"
    "Each plugin folder must contain a plugin.json manifest."
)
CB_PLUGIN_ENABLE_PROFILE_FMT = "Profile ({profile})"
LBL_PLUGIN_PROFILE_NONE = "none"
BTN_PLUGIN_OPEN_FOLDER = "Open folder"
MSG_PLUGIN_MANAGER_SAVE_FAILED = "Failed to save config:\n{error}"
MSG_PLUGIN_ROOT_NOT_SET = "CZT root folder not set. Cannot load plugins."
LBL_PLUGIN_STANDALONE_EXE = "Standalone EXE:"
LBL_PLUGIN_SCRIPTS = "Scripts:"
LBL_PLUGIN_NONE_STANDALONE = "No standalone EXE plugins found."
LBL_PLUGIN_NONE_SCRIPTS = "No script plugins found."
CB_PLUGIN_ENABLE_PROFILE = "Enable for Profile"
CB_PLUGIN_ENABLE_GLOBAL = "Enable Globally"
CB_PLUGIN_RUN_STARTUP = "Run at Startup"
BTN_PLUGIN_RUN = "Load"
BTN_PLUGIN_UNLOAD = "Unload"
BTN_PLUGIN_SAVE_STARTUP_OPTIONS = "Save Startup Options"
BTN_PLUGIN_CLOSE = "Close"
DLG_TITLE_PLUGIN_RUN_AS_ADMIN = "Run as Administrator? (optional)"
MSG_PLUGIN_RUN_AS_ADMIN = "Would you like to run {plugin_name} as administrator?"
DLG_TITLE_PLUGIN = "Plugin"
MSG_PLUGIN_LAUNCHED = "Launched: {plugin_name}"
DLG_TITLE_PLUGIN_ERROR = "Plugin Error"
MSG_PLUGIN_LAUNCH_FAILED = "Failed to launch plugin:\n{error}"
MSG_PLUGIN_UNLOAD_FAILED = "Failed to unload plugin:\n{error}"
MSG_PLUGIN_UNLOADED = "Unloaded: {plugin_name}\n\nNote: This only removes the module from memory.\nRunning threads, signals, or UI elements may remain unless the plugin cleans itself up."
MSG_PLUGIN_NOTHING_TO_UNLOAD = "Nothing to unload for: {plugin_name}"
DLG_TITLE_PLUGIN_STARTUP_REQUIREMENTS = "Startup Requirements Not Met"
MSG_PLUGIN_STARTUP_REQUIREMENTS = "Plugins set to launch at start must be enabled Globally or for a Profile.\nThese plugins will not be loaded at start until fixed:\n- {plugins}"
DLG_TITLE_SAVED = "Saved"
MSG_PLUGIN_OPTIONS_SAVED = "Plugin options saved."
DLG_TITLE_SAVE_ERROR = "Save Error"
MSG_PLUGIN_OPTIONS_SAVE_FAILED = "Failed to save plugin options:\n{error}"
...
LOG_AUDIO_MENU_MUSIC_PAUSED = "[AUDIO] Menu music paused. Restart CZT to reset, or resave audio settings to resume."
LOG_LAUNCH_LOAD_ORDER_READ_FAILED = "[LAUNCH] Could not read load order: {error}"
LOG_CONFIG_RELOAD_FAILED = "[ERROR] Could not reload config from disk: {error}"
LOG_LAUNCH_SEARCHING_EXE = "[FIRST TIME LAUNCH]\n- Searching for EXE in: {steam_libraries}"
LOG_LAUNCH_EXE_NOT_FOUND = "[ERROR] Could not find EXE for {game_name}!"
LOG_NO_ROOT_SET = "[ERROR] No root folder set! Click 'CREATE ROOT' to begin using CZT."
LOG_LAUNCH_CREATED_MODS_FOLDER = "[LAUNCH] Created missing mods folder: {path}"
LOG_LAUNCH_CREATED_MODS_FOLDER_PARENT = "[LAUNCH] Created missing mods folder parent: {path}"
LOG_MODS_FOLDER_PREP_FAILED = "[ERROR] Could not prepare mods folder path {path}: {error}"
LOG_LAUNCH_CANCELLED = "[LAUNCH] {game_name} launch cancelled by user!"
LOG_TOTAL_LINKED = "[TOTAL] {count} mod(s) linked"
LOG_PER_FILE_REMOVE_FAILED = "[PER-FILE] Could not remove symlink {path}: {error}"
LOG_TYPE_SYMLINKS_REMOVED = "[{mod_type}] {count} symlink(s) removed"
LOG_PER_FOLDER_REMOVE_FAILED = "[PER-FOLDER] Could not remove symlink/junction {path}: {error}"
LOG_PER_FOLDER_REMOVED_COUNT = "[PER-FOLDER] {count} symlink(s)/junction(s) removed"
LOG_LINK_DISABLED_MODS_JUNCTION = "[LINK] Disabled Mods junction: {path}"
LOG_LINK_DISABLED_MODS_SYMLINK = "[LINK] Disabled Mods symlink: {path}"
LOG_LINK_REMOVE_MODS_SYMLINK_FAILED = "[LINK] Could not remove Mods symlink: {error}"
LOG_LAUNCH_STEAM_START = "[LAUNCH] Steam is launching app ID: {steam_appid} > {game_name} > {mode}"
LOG_STEAM_LAUNCH_FAILED_FALLBACK = "[ERROR] Could not launch with Steam: {error}\nFalling back to EXE launch."
LOG_LAUNCH_STARTED_GAME = "[LAUNCH] Started game: {exe_path} {mode}"
LOG_HOTKEY_LINK_DONE = "[F7-LINK] {game_name}: Enabled mods have been linked successfully."
LOG_HOTKEY_UNLINK_DONE = "[F8-UNLINK] {game_name}: Mod links have been removed successfully."
LOG_ELEVATION_REQUIRED_RELAUNCH = "[ERROR] Elevation required: {error}\nAttempting to relaunch as admin..."
LOG_PERMISSION_DENIED_SIMPLE = "[ERROR] Permission denied: {error}"
LOG_LAUNCH_TOGGLE_FAILED_SIMPLE = "[ERROR] Could not toggle mods or launch game: {error}"
LOG_TYPE_LINKING_TO = "[{mod_type}] Linking {count} mod(s) to {destination}"
LOG_MOD_LIST_ITEM = "  - {mod_name}"
LOG_LINK_MODS_DIR_MISSING = "[LINK] Mods dir not found or disabled: {path}"
LOG_LINK_EXE_FAILED = "[LINK] Could not link {file_name} to exe dir: {error}"
LOG_LINK_MODS_FOLDER_NOT_EMPTY = "[LINK] Cannot replace existing mods folder because it is not empty: {path}"
LOG_LINK_PREP_MODS_FOLDER_FAILED = "[LINK] Could not prepare Mods folder for junction: {error}"
LOG_LINK_ENABLED_MODS_SUMMARY = "[LINK] Enabled mods: \n - Source: {source}\n - Linked to -> {destination}"
LOG_PER_FILE_CLEAN_FAILED = "[PER-FILE] Failed to clean {path}: {error}"
LOG_PER_FILE_LINK_FAILED = "[PER-FILE] Failed to link {file_name}: {error}"
LOG_CONTENT_GAME_DIR_NOT_FOUND = "[CONTENT MOD] Game Content dir not found: {path}"
LOG_CONTENT_BACKUP_FAILED = "{tag} Could not back up {path}, skipping: {error}"
LOG_CONTENT_LINK_FAILED = "{tag} Failed to link {file_name}: {error}"
LOG_CONTENT_SKIP_JUNCTION_REAL_DIR = "{tag} Skipping junction, real dir exists: {sub_name}"
LOG_CONTENT_JUNCTION_FAILED = "{tag} Failed to junction {sub_name}: {error}"
LOG_PER_FOLDER_CLEAN_FAILED = "[PER-FOLDER] Failed to clean {path}: {error}"
LOG_PER_FOLDER_LINKED_COUNT = "[PER-FOLDER] Linked {count} folder(s) -> {destination}"
LOG_IS_JUNCTION_FAILED = "[ERROR] is_junction failed: {error}"
LOG_RMDIR_FAILED = "[ERROR] rmdir failed for {link}: {error}"
LOG_REMOVE_FILE_LINK_FAILED = "[ERROR] Failed to remove file link: {link} - {error}"
LOG_REMOVE_JUNCTION_EXCEPTION = "[ERROR] Exception in remove_junction for {link}: {error}"
LOG_ASI_DLL_REMOVE_FAILED = "[ASI_DLL] Could not remove asi/dll symlink {path}: {error}"
LOG_CONTENT_GAME_DIR_NOT_FOUND_SKIP_UNLINK = "[CONTENT MOD] game_content_dir not found, skipping unlink: {path}"
LOG_CONTENT_UNLINK_FAILED = "{tag} Failed to unlink {path}: {error}"
LOG_CONTENT_RESTORE_FAILED = "{tag} Failed to restore {path}: {error}"
LOG_CONTENT_UNLINKED_COUNT = "{tag} Unlinked {count} mod(s)"
LOG_CONTENT_ORPHAN_REMOVED = "[CONTENT MOD] Removed {count} orphaned link(s) (safety sweep)"
LOG_CONTENT_PRESERVE_DIR_CREATED = "[CONTENT MOD] Re-created required folder: {path}"
LOG_CONTENT_PRESERVE_DIR_FAILED = "[CONTENT MOD] Failed to ensure required folder {path}: {error}"
LOG_LINK_DISABLED_FOLDER_JUNCTION = "[LINK] Disabled folder junction: {path}"
LOG_LINK_DISABLED_FOLDER_SYMLINK = "[LINK] Disabled folder symlink: {path}"
LOG_LINK_REMOVE_FOLDER_FAILED = "[LINK] Error removing folder link {path}: {error}"
LOG_LINK_DISABLED_FILE_SYMLINK = "[LINK] Disabled file symlink: {path}"
LOG_LINK_REMOVED_FILE = "[LINK] Removed file: {path}"
LOG_LINK_REMOVE_FILE_FAILED = "[LINK] Error removing file link {path}: {error}"
LOG_ELEVATION_FAILED_SIMPLE = "[ERROR] Elevation failed: {error}"
LOG_DEV_MODE_SETTINGS_OPEN_FAILED = "[ERROR] Failed to open Dev Mode settings: {error}"
...
LOG_FORZATECH_AUTOSCOPE_CARBIN_NAME = "[ForzaTech][autoscope] Detected .carbin '{carbin}' in '{archive}' -> naming car bundle '{name}'."
LOG_FORZATECH_AUTOSCOPE_ZIP_UNSCOPED = "[ForzaTech] Could not determine a category for content archive '{name}'"
LOG_FORZATECH_AUTOSCOPE_FAILED = "[ForzaTech] Auto-scope failed for '{mod}': {error}"
LOG_FORZATECH_AUTOSCOPE_NO_MEDIA = "[ForzaTech][autoscope] No installed media/ found; using heuristics only."
LOG_FORZATECH_AUTOSCOPE_INDEXING = "[ForzaTech][autoscope] Indexing vanilla media/ tree (first run)..."
LOG_FORZATECH_AUTOSCOPE_INDEXED = "[ForzaTech][autoscope] Indexed {files} vanilla file names across {categories} categories."
LOG_FORZATECH_AUTOSCOPE_UNNESTED = "[ForzaTech][autoscope] Un-nested already-scoped mod '{mod}'."
LOG_FORZATECH_AUTOSCOPE_MEDIA_TO_MEDIAPC = "[ForzaTech][autoscope] Normalized top-level 'media' -> 'mediapc' for '{mod}'."
LOG_FORZATECH_AUTOSCOPE_LOADER_SKIPPED = "[ForzaTech][autoscope] '{mod}' ships a .dll/.asi loader; autoscope skipped."
LOG_FORZATECH_AUTOSCOPE_UNSCOPED = "[ForzaTech][autoscope] Could not determine a category for {count} file(s) in '{mod}'; left unscoped."
LOG_FORZATECH_AUTOSCOPE_RESCOPED = "[ForzaTech][autoscope] Rescoped '{mod}': {count} file(s) -> mediapc/."
LOG_FORZATECH_AUTOSCOPE_UNRESOLVED = "[ForzaTech][autoscope] {count} file(s) in '{mod}' left unscoped (unknown category)."
LOG_FORZATECH_AUTOSCOPE_MOVE_FAILED = "[ForzaTech][autoscope] Failed to move '{path}': {error}"
LOG_FORZATECH_AUTOSCOPE_REZIPPED_CAR = "[ForzaTech][autoscope] Re-zipped loose car bundle -> mediapc/Cars/{name}.zip"
LOG_FORZATECH_AUTOSCOPE_REZIP_FAILED = "[ForzaTech][autoscope] Car bundle re-zip failed for '{name}': {error}"
LOG_FORZATECH_AUTOSCOPE_REZIPPED_CAR = "[ForzaTech][autoscope] Re-zipped loose car bundle -> mediapc/Cars/{name}.zip"
LOG_FORZATECH_AUTOSCOPE_REZIP_FAILED = "[ForzaTech][autoscope] Car bundle re-zip failed for '{name}': {error}"
LOG_FORZATECH_NO_ENABLED_MODS = "[ForzaTech] No enabled mods to deploy."
LOG_FORZATECH_REUSING_OVERLAY = "[ForzaTech] Staged mods unchanged --> reusing existing overlay."
LOG_FORZATECH_BUILT_OVERLAY = "[ForzaTech] Built merged overlay: {count} file(s) from {mods} mod(s)."
LOG_FORZATECH_DEPLOYED = "[ForzaTech] Deployed {count} overlay object(s) into {path}."
LOG_FORZATECH_JUNCTION_FAILED = "[ForzaTech] Junction failed for {name}: {error}"
LOG_FORZATECH_JUNCTION_REFRESH_FAILED = "[ForzaTech] Junction refresh failed for {name}: {error}"
LOG_FORZATECH_OVERLAY_LINK_FAILED = "[ForzaTech] Overlay link failed for {path}: {error}"
LOG_FORZATECH_REMOVE_FAILED = "[ForzaTech] Could not remove {path}: {error}"
LOG_FORZATECH_OVERLAY_CLEANUP_FAILED = "[ForzaTech] Overlay cleanup failed for {path}: {error}"
LOG_FORZATECH_SWEPT_ORPHANS = "[ForzaTech] Removed {count} dead overlay link(s) that the manifest missed."
LOG_FORZATECH_REMOVED = "[ForzaTech] Removed {count} overlay object(s) from {path}"

# ===== install_mods/archive_handler/archive_handler_core.py logs =====
LOG_INSTALL_CONTENT_ADDED_MOD = "[{mod_type}] Added mod: {mod_label}"
LOG_INSTALL_CONTENT_ADDED_FOLDER_MOD = "[{mod_type}] Added folder mod: {mod_name}"
LOG_COPY_CONTENT_MOD_FOLDER_FAILED = "[ERROR] copy_content_mod_folder failed: {error}"
LOG_INSTALL_FILE_FAILED = "[ERROR] An error occurred installing {install_name}: {error}"
...
DLG_TITLE_DOWNLOADING_MODS    = "Downloading mods"
DLG_TITLE_DOWNLOADING_UPDATES = "Downloading mod updates"
LBL_DOWNLOAD_ROW_DEFAULT      = "Download #{num}"
LBL_DOWNLOADS_COMPLETE        = "{done} / {total} downloads complete"
LBL_DOWNLOADS_REMAINING       = "{count} remaining in queue"

# ===== install_mods/consolidated_install_dialog.py & loadout pin flow =====
DLG_TITLE_RESOLVE_INSTALL     = "Resolve install choices"
DLG_TITLE_SELECT_FILES_PIN    = "Select files to pin"
DLG_TITLE_SELECT_FILES_DOWNLOAD = "Select file(s) to download"
LBL_RESOLVE_HEADER            = "{count} mod(s) need attention.\nMake selections below, then click Apply."
LBL_HDR_MOD_ARCHIVE           = "Mod Archive:"
LBL_HDR_INSTALLED_MOD         = "Installed Mod:"
LBL_HDR_CHOOSE_DOWNLOAD       = "Choose a file to download:"
LBL_HDR_SELECT_LOADOUT_FILE   = "Select file to use in loadout:"
LBL_HDR_ARCHIVE_OPTIONS       = "Archive Options: (select a file to install)"
LBL_HDR_REPLACE_OR_NEW        = "Replace an existing file, or install as new:"
LBL_UNKNOWN_MOD_INLINE        = "(unknown)"
LBL_FILE_NUM                  = "File {file_id}"
OPT_SKIP_DOWNLOAD             = "(skip download)"
...
LBL_PIN_SELECT_HEADER         = "Select file to pin"
LBL_CTX_MOD_NAME              = "Mod Name: {name}"
LBL_CTX_LOADOUT               = "Loadout: {name}"
LBL_CTX_INSTALLED_FILE        = "Installed File: {name}"
LBL_CTX_MOD_FILE              = "Mod File: {name}"
LBL_MOD_FALLBACK              = "Mod {mod_id}"
LBL_TARGET_UNKNOWN            = "unknown"
