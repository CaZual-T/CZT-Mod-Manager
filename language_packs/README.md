...
- example language_config.py:
  ...
  - LANGUAGE_CODE = "en"
    - language code (e.g., 'es', 'de', 'fr', 'ru'). IMPORTANT: This should match the languages folder name, it can be anything as long as it's consistent with the folder name.
