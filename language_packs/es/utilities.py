...
LOG_HOTKEY_LINK_DONE = "[F7-LINK] {game_name}: mods enlazados correctamente a {path} (Hotkey - sin iniciar)"
LOG_HOTKEY_UNLINK_DONE = "[F8-UNLINK] {game_name}: todos los mods se desenlazaron correctamente."
...
LOG_FORZATECH_DEPLOYED = "[ForzaTech] Se desplegaron {count} objeto(s) de superposicion en {path}."
...
LOG_FORZATECH_REMOVED = "[ForzaTech] Se eliminaron {count} objeto(s) de superposicion de {path}."
