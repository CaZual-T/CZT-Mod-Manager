...
LOG_HOTKEY_LINK_DONE = "[LINK] {game_name}: mods enlazados correctamente a {path} (Hotkey - sin iniciar)"
LOG_HOTKEY_UNLINK_DONE = "[UNLINK] {game_name}: todos los mods se desenlazaron correctamente."
...
LOG_LAUNCH_REFRESHING_SYMLINKS = "[LINK] Actualizando symlinks..."
...
LOG_FORZATECH_AUTOSCOPE_INDEXING = "[ForzaTech][autoscope] Indexando el arbol vanilla de media/ (primera ejecucion)..."
LOG_FORZATECH_AUTOSCOPE_INDEXED = "[ForzaTech][autoscope] Se indexaron {files} nombres de archivo vanilla en {categories} categorias."
LOG_FORZATECH_AUTOSCOPE_UNNESTED = "[ForzaTech][autoscope] Se desanido el mod ya pre-ubicado '{mod}'."
LOG_FORZATECH_AUTOSCOPE_MEDIA_TO_MEDIAPC = "[ForzaTech][autoscope] Se normalizo la carpeta superior 'media' -> 'mediapc' para '{mod}'."
LOG_FORZATECH_AUTOSCOPE_LOADER_SKIPPED = "[ForzaTech][autoscope] '{mod}' contiene un cargador .dll/.asi; se omite autoscope."
LOG_FORZATECH_AUTOSCOPE_UNSCOPED = "[ForzaTech][autoscope] No se pudo determinar una categoria para {count} archivo(s) en '{mod}'; se dejaron sin ubicar."
...
LOG_FORZATECH_REUSING_OVERLAY = "[ForzaTech] Mods preparados sin cambios --> reutilizando la superposicion existente."
LOG_FORZATECH_BUILT_OVERLAY = "[ForzaTech] Superposicion fusionada creada: {count} archivo(s) de {mods} mod(s)."
LOG_FORZATECH_DEPLOYED = "[ForzaTech] Se desplegaron {count} objeto(s) de superposicion en el juego."
LOG_FORZATECH_JUNCTION_FAILED = "[ForzaTech] Fallo la union (junction) para {name}: {error}"
LOG_FORZATECH_JUNCTION_REFRESH_FAILED = "[ForzaTech] Fallo la actualizacion de la union (junction) para {name}: {error}"
LOG_FORZATECH_OVERLAY_LINK_FAILED = "[ForzaTech] Fallo el enlace de superposicion para {path}: {error}"
LOG_FORZATECH_REMOVE_FAILED = "[ForzaTech] No se pudo eliminar {path}: {error}"
LOG_FORZATECH_OVERLAY_CLEANUP_FAILED = "[ForzaTech] Fallo la limpieza de superposicion para {path}: {error}"
LOG_FORZATECH_SWEPT_ORPHANS = "[ForzaTech] Se eliminaron {count} enlace(s) de superposicion muertos que el manifiesto omitio."
LOG_FORZATECH_REMOVED = "[ForzaTech] Se eliminaron {count} objeto(s) de superposicion del juego."
...
DLG_TITLE_SELECT_FILES_DOWNLOAD = "Seleccionar archivo(s) para descargar"
...
LBL_UNKNOWN_MOD_INLINE        = "(desconocido)"
