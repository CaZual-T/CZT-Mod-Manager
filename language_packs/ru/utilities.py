...
MSG_HOTKEY_CONTROLS = (
    ...
    "    > F6           : Добавить / изменить пользовательские профили игр.\n"
...
LOG_HOTKEY_LINK_DONE = "[F7-LINK] {game_name}: моды успешно привязаны к {path} (Hotkey - без запуска)"
LOG_HOTKEY_UNLINK_DONE = "[F8-UNLINK] {game_name}: все моды успешно отвязаны."
...
LOG_FORZATECH_BUILT_OVERLAY = "[ForzaTech] Создано объединенное наложение: {count} файл(ов) из {mods} мод(ов)."
LOG_FORZATECH_DEPLOYED = "[ForzaTech] Развернуто {count} объект(ов) наложения в {path}."
...
LOG_FORZATECH_SWEPT_ORPHANS = "[ForzaTech] Удалено {count} мертвых ссылок наложения, пропущенных манифестом."
LOG_FORZATECH_REMOVED = "[ForzaTech] Удалено {count} объект(ов) наложения из {path}."
