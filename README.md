...
- ⭐ Main + Optional files available on the mod page will be listed (drop down selection) in-app upon download.
- ⭐ Catches when a mod has multiple versions in an archive, allows you to choose a file or install all.
