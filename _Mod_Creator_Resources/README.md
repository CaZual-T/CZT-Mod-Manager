...
===========================================
{
  ...
  "destination": "profile_mods/Ready or Not/"
}
...
- // (Single File Mods)
{
  ...
  "mod_local_version": "5.2",
  "nexus_url": "https://www.nexusmods.com/dyinglightthebeast/mods/256",
  "files_to_install": [
    {
      "source": "data3.pak",
      "destination": "profile_mods/DL The Beast/data3.pak"
    }
  ]
}
...
- // OR
{
  ...
  "mod_local_version": "1.0.3",
  "nexus_url": "https://www.nexusmods.com/dyinglightthebeast/mods/202",
  "files_to_install": [
    { "source": "data4.pak", "destination": "profile_mods/DL The Beast/data4.pak"}
  ]
}
...
- // (Multiple Files At Once)
{
  ...
  "files_to_install": [
    {
      "source": "RemoveSafeZoneRestrictions.asi",
      "display_name": "Remove SZR (ASI)",
      "mod_local_version": "6.29",
      "destination": "profile_mods/DL The Beast/RemoveSafeZoneRestrictions.asi"
    },
    {
      "source": "winmm.dll",
      "display_name": "Remove SZR (DLL)",
      "mod_local_version": "6.29",
      "destination": "profile_mods/DL The Beast/winmm.dll"
    }
  ]
}
...
- // Ready or Not (Multiple Files At Once)
{
  ...
  "files_to_install": [
    ...
    {
        "source": "pakchunk999-Mods_BAL_LSS3_Addon_KAC_L403A1_P.pak",
        "display_name": "KAC_L403A1",
        "mod_local_version": "1.3"
    },
    {
        "source": "pakchunk999-Mods_BAL_RC_Addon_BCM-Recce14-KMR_P.pak",
        "display_name": "BCM-Recce14",
        "mod_local_version": "1.4"
    },
    {
        "source": "pakchunk999-Mods_BAL_UE5_Nightvision-Expansion_P.pak",
...
- // Schedule I
{
  ...
  "files_to_install": [
    {
      "source": "CartelInfluenceEnhancements.dll",
      "destination": "profile_mods/Schedule I/Mods/CartelInfluenceEnhancements.dll",
      "mod_local_version": "0.29"
    }
  ]
}
