1:) rename any new or existing version.dlls from other mods to NameOfChoice-version.dll 

2:) place my "version.dll" inside of the main forza horizon 6 folder --> ForzaHorizon6\version.dll

3:) launch game. thats it.

all of my loaders look for a prefix of themselves essentially
...
star* = name you choose before the prefix.
